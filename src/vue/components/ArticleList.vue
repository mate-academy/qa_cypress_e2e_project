<template>
  <div>
    <div v-if="is_loading" class="article-preview" data-qa="article-preview">Loading articles...</div>
    <div v-else>
      <div v-if="articles.length === 0" class="article-preview" data-qa="article-preview">
