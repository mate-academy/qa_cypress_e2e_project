<template>
  ...
  <span v-if="canModify">
    <router-link class="btn btn-sm btn-outline-secondary data-qa="editBtn"" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-qa="deleteBtn" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
