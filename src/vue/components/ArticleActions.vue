<template>
  ...
  <span v-if="canModify">
    <router-link data-cy="edit-art-btn" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-cy="delete-art-btn" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
