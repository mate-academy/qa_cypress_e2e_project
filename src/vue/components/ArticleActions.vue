<template>
  ...
  <span v-if="canModify">
    <router-link data-qa="edit-article" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-qa="delete-article" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
      <i class="ion-trash-a"></i> <span>&nbsp;Delete Article</span>
    </button>
  </span>
  <!-- Used in ArticleView when not author -->
  <span v-else>
    <button data-qa="follow-btn" class="btn btn-sm btn-outline-secondary" @click="toggleFollow">
