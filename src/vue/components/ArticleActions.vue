<template>
  ...
  <span v-if="canModify">
    <router-link class="btn btn-sm btn-outline-secondary" :to="editArticleLink" data-cy="editArticle">
      <i class="ion-edit"> data-cy="editArticle" </i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button class="btn btn-outline-danger btn-sm" @click="deleteArticle">
      <i class="ion-trash-a"> data-cy="deleteArticle" </i> <span>&nbsp;Delete Article</span>
    </button>
  </span>
