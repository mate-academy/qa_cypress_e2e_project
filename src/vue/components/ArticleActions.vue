<template>
  ...
  <span v-if="canModify">
    <router-link class="btn btn-sm btn-outline-secondary" data-cy="edit-article-link" :to="editArticleLink">
  ...
  <span v-else>
    <button class="btn btn-sm btn-outline-secondary" data-cy="follow-btn" @click="toggleFollow">
