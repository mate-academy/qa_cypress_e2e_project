<template>
  ...
  <span v-if="canModify">
    <router-link dataqa="edit-article-btn" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button dataqa="delete-article-btn" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
