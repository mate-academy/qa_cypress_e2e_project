<template>
  ...
  <span v-if="canModify">
    <router-link data-qa="Edit article btn"
     class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-qa="Delete article btn"
  ...
  <span v-else>
    <button data-qa="Edit article btn"
    class="btn btn-sm btn-outline-secondary" @click="toggleFollow">
