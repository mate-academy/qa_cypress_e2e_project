<template>
  ...
  <span v-if="canModify">
    <router-link data-cy="edit-article-link" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
  ...
  <span v-else>
    <button data-cy="follow-btn" class="btn btn-sm btn-outline-secondary" @click="toggleFollow">
