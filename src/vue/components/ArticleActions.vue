<template>
  ...
  <span v-if="canModify">
    <router-link data-cy=edit-article class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i ></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-cy=delete-article class="btn btn-outline-danger btn-sm" @click="deleteArticle">
