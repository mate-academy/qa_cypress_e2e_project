<template>
  ...
  <span v-if="canModify">
    <router-link data-cy="editArticleButton" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-cy="deleteArticleButton" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
      <i class="ion-trash-a"></i> <span>&nbsp;Delete Article</span>
    </button>
  </span>
  <!-- Used in ArticleView when not author -->
  <span v-else>
    <button data-cy="followUserButton" class="btn btn-sm btn-outline-secondary" @click="toggleFollow">
