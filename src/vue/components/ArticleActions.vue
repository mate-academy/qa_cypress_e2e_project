<template>
  ...
  <span v-if="canModify">
    <router-link class="btn btn-sm btn-outline-secondary" data-cy="editArticle-button" :to="editArticleLink">
      <i class="ion-edit"></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span> 
    <button class="btn btn-outline-danger btn-sm"  @click="deleteArticle" data-cy="deleteArticle-button"> 
    <i class="ion-trash-a"></i> <span>"&nbsp;Delete Article</span>
    </button> 
  </span> 
  <!-- Used in ArticleView when not author -->
  <span v-else>
    <button data-cy="followuser-button" class="btn btn-sm btn-outline-secondary" @click="toggleFollow">
