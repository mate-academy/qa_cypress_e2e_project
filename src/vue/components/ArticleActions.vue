<template>
  ...
  <span v-if="canModify">
    <router-link data-qa= "article_editBtn" class="btn btn-sm btn-outline-secondary" :to="editArticleLink">
      <i class="ion-edit" ></i> <span>&nbsp;Edit Article</span>
    </router-link>
    <span>&nbsp;&nbsp;</span>
    <button data-qa="article_deleteBtn" class="btn btn-outline-danger btn-sm" @click="deleteArticle">
