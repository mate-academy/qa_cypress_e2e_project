        ...
        <div class="col-md-10 offset-md-1 col-xs-12">
          ...
          <form @submit.prevent="onPublish(article.slug)">
            <fieldset :disabled="publishing_article">
              ...
              <fieldset class="form-group">
                <input
                  ...
                  data-qa="article-page-about-article"
                />
              </fieldset>
              <fieldset class="form-group">
                <textarea
                  ...
                  data-qa="article-page-article-body"
                >
                </textarea>
              </fieldset>
              <fieldset class="form-group"
              data-qa="article-page-article-tag">
                <vue-tags-input
            ...
            <button
              ...
              type="submit"
              data-qa="article-page-submit-button"
            >
              Publish Article
            </button>
          </form>
