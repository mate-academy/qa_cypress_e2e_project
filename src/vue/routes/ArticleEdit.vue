      ...
      <div class="row">
        <div class="col-md-10 offset-md-1 col-xs-12">
          ...
          <form @submit.prevent="onPublish(article.slug)">
            <fieldset :disabled="publishing_article">
              <fieldset class="form-group">
                <input
                  ...
                  data-cy="create-article-title-field"
                />
              </fieldset>
              <fieldset class="form-group">
                <input
                  ...
                  data-cy="create-article-description-field"
                />
              </fieldset>
              <fieldset class="form-group">
                <textarea
                  ...
                  data-cy="create-article-body-field"
                >
                </textarea>
              </fieldset>
              <fieldset class="form-group">
                <vue-tags-input
                  ...
                  data-cy="create-article-tag-field"
                  class="form-control"
                  v-model="tag"
                  :tags="tags"
            ...
            <button
              :disabled="publishing_article" data-cy="publish-article-btn"
