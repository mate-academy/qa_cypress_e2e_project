        ...
        <div class="col-md-10 offset-md-1 col-xs-12">
          ...
          <form @submit.prevent="onPublish(article.slug)">
            <fieldset :disabled="publishing_article">
              ...
              <fieldset class="form-group">
                <input
                  ...
                  data-qa="input-article-description"
                />
              </fieldset>
              <fieldset class="form-group">
                <textarea
                  ...
                  data-qa="input-article-body"
                >
                </textarea>
              </fieldset>
              <fieldset class="form-group"  data-qa="input-article-tags">
                <vue-tags-input
            ...
            <button
              ...
              class="btn btn-lg pull-xs-right btn-primary" data-qa="publish-article-btn"
              type="submit"
            >
              Publish Article
            </button>
