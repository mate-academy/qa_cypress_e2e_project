            ...
            <fieldset :disabled="publishing_article">
              ...
              <fieldset class="form-group">
                <textarea
                  ...
                  data-cy="articleBodyField"
                >
                </textarea>
              </fieldset>
              <fieldset class="form-group" data-cy="articleTagField">
                <vue-tags-input
