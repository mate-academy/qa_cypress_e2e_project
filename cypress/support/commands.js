...
// eslint-disable-next-line max-len
Cypress.Commands.add('registerUser1', (email = 'riot@qa.team', username = 'riot', password = '12345Qwert!') => {
  cy.request('POST', '/users', {
    email,
    username,
    password
...
// eslint-disable-next-line max-len
Cypress.Commands.add('registerUser2', (email = 'riot@qa.team', username = 'riot', password = '12345Qwert!') => {
  cy.request('POST', '/users', {
    email,
    username,
    password
