...
describe('Article', () => {
  ...
  it('should be created using New Article form', () => {
    ...
    articlePage.assertNewArticleCreated(article.title, article.body, article.tag);
    homePage.visit();
    homePage.assertArticleComponentsExist(article.title, article.description, article.tag);
  });
  ...
  it('should be edited using Edit button', () => {
    cy.createArticle(
      ...
      newArticlePage.clickNewArticleButton();
      articlePage.assertNewArticleCreated(article.updatedTitle, article.updatedBody, article.tag);
      homePage.visit();
      homePage.assertArticleComponentsExist(article.updatedTitle, article.updatedDescription, article.tag);
  });
  ...
  it.only('should be deleted using Delete button', () => {
    cy.createArticle(
      ...
      homePage.assertArticleDeleted(article.title, article.description, article.tag);
  });
});
