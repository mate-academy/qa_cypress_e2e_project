...
describe('Article', () => {
  ...
  before(() => {
    ...
    cy.task('generateArticle').then((generatedArticle2) => {
  ...
  it.skip('should be created using New Article form', () => {
    ...
    articlePage.assertBannerContainsTitle(article.title);
  });
  ...
  it.only('should be edited using Edit button', () => {
    ...
    articlePage.typeDescription(editArticle.description);
    articlePage.typeBody(editArticle.body);
    articlePage.clickSubmitBtn();

    articlePage.assertBannerContainsTitle(editArticle.title);
  });
  ...
  it('should be deleted using Delete button', () => {
    ...
    articlePage.assertDeletedArticle();
  });
});
