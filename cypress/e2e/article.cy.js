...
describe('Article', () => {
  ...
  it('should be edited using Edit button', () => {
    cy.createArticle(testData.title, testData.description, testData.body, testData.tag)
      .then((respons) => {
  ...
  it('should be deleted using Delete button', () => {
    cy.createArticle(testData.title, testData.description, testData.body, testData.tag).then((response) => {
    ...
    homePage.checkAfterArticleDelete();
  });
});
