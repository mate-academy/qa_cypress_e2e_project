...
let user;
const passwordValidation = 'Password must be 8 characters long and include 1 number, 1 uppercase letter, and 1 lowercase letter.'
...
//Positive Tests
  ...
  it.only('should register the user with all vilid data', () => {
    //Go to the Home Page 
    cy.visit('/#/');
