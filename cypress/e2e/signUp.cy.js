...
describe('Sign Up page', () => {
  ...
  it(
    'should show an error message in case of sign up with invalid email',
    () => {
      signUpPage.typeUsername(user.username);
  ...
  it(
    'should show an error message in case of sign up with invalid password',
    () => {
      signUpPage.typeUsername(user.username);
      signUpPage.typeEmail(user.email);
  ...
  it(
    'should show an error message in case of sign up with empty username',
    () => {
      signUpPage.typeEmail(user.email);
      signUpPage.typePassword(user.password);
      signUpPage.clickSignUpBtn();
  ...
  it(
    'should show an error message in case of sign up with empty password',
    () => {
      signUpPage.typeUsername(user.username);
      signUpPage.typeEmail(user.email);
      signUpPage.clickSignUpBtn();
