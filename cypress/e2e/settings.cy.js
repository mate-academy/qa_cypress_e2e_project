...
describe('Settings page', () => {
  ...
  it('should provide an ability to update username', () => {
    ...
    settingsPage.visit();
    settingsPage.addNewUsername(testUser.username);
  ...
  it('should provide an ability to update bio', () => {
    cy.register(user.email, user.username, user.password);
    settingsPage.visit();
    settingsPage.addNewBio(testUser.bio);
    settingsPage.clickUpdateBtn();
    settingsPage.popWindow();
    homePage.usernameLink.click();
    settingsPage.assertBio(testUser.bio);
  });

  it('should provide an ability to update an email', () => {
    cy.register(user.email, user.username, user.password);
    settingsPage.visit();
    settingsPage.addNewEmail(testUser.email);
    settingsPage.clickUpdateBtn();
    settingsPage.popWindow();
  ...
  it('should provide an ability to update password', () => {
    cy.register(user.email, user.username, user.password);
    settingsPage.visit();
    settingsPage.addNewPassword(testUser.password);
    settingsPage.clickUpdateBtn();
    settingsPage.popWindow();
    settingsPage.clickLogoutBtn();
    signInPage.visit();
