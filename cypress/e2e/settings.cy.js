...
describe('Settings page', () => {
  ...
  it('should provide ability to update username', () => {
    settingsPage.visit();
  ...
  it('should provide ability to update bio', () => {
    settingsPage.visit();
  ...
  it('should provide ability to update an email', () => {
    settingsPage.visit();
  ...
  it('should provide ability to update password', () => {
    settingsPage.visit();
  ...
  it('should provide ability to log out', () => {
    settingsPage.visit();
    settingsPage.clickOnLogoutBtn();
